...
import ComfirmModal from "./components/Other/Modal/ComfirmModal";
...
function App() {
  ...
  return (
    <div className="app-background relative bg-gray-100 dark:bg-gray-800 w-full min-h-screen">
      ...
      <div className="absolute left-56 w-[calc(100%-14rem)]  min-h-screen flex flex-col  pl-4 md:p-4 md:space-y-4  max-w-[2560px]">
        ...
        <Routes>
          ...
          <Route path="/r2g/airdrop" element={<Airdrop />} />
          <Route
            path="/r2g/account"
            element={<Table title="Account" hasFilter={true} data={data} />}
          />
          {/* <Route
						path="/r2g/user"
						element={<ApexChart2 />}
