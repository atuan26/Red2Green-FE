  ...
  return (
    <>
      ...
      >
        ...
        {toggleAvatar &&
          <div className="absolute right-0 z-20 w-56 py-2 mt-2 overflow-hidden bg-gray-50 rounded-md shadow-xl dark:bg-gray-800">
  ...
  return <>
    <div className="flex items-center justify-center ">
      <div className="relative inline-block">
        ...
        {toggleNotify &&
          <div className="absolute right-0 z-20 mt-2 overflow-hidden bg-gray-50 rounded-md shadow-lg w-80 dark:bg-gray-800">
            <div className="py-2">
