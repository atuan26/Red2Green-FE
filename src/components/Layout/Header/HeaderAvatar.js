      ...
      >
        ...
        {isComponentVisible &&
          <div className=" hover:shadow border  absolute right-0 z-20 w-56 py-2 mt-2 overflow-hidden bg-white rounded-md  dark:bg-gray-800">
            ...
            <HeaderAvatarItem label="View Profile" link='r2g/profile' icon={<BiUser className={classNameIcon} />} />
            <HeaderAvatarItem label="Settings" icon={<RiSettings5Line className={classNameIcon} />} />
            <hr className="border-gray-200 dark:border-gray-700 " />
            <HeaderAvatarItem label="Company" icon={<CgOrganisation className={classNameIcon} />} />
            <HeaderAvatarItem label="Team" icon={<RiTeamLine className={classNameIcon} />} />
            <HeaderAvatarItem label="Invite friends" icon={<HiOutlineUserAdd className={classNameIcon} />} />
            <hr className="border-gray-200 dark:border-gray-700 " />
            <HeaderAvatarItem label="Help" icon={<MdHelpOutline className={classNameIcon} />} />
            <HeaderAvatarItem label="Logout" icon={<IoLogOutOutline className={classNameIcon} />} onClick={logout} />
          </div>
        }
      </div>
    </>
    ...
    <div ref={ref} className="flex items-center justify-center ">
      <div className="relative inline-block">
        <button
          ...
          <svg className="w-5 h-5 text-gray-800 dark:text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
