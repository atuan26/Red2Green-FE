  ...
  const navItem1 = useMemo(
    () => [
      ...
      },
      {
        ...
        icon: <GrUserAdmin />,
        notification: 0,
        href: "/r2ghttp://127.0.0.1:8000/admin",
        target: "_blank",
        adminRequired: true,
      },
      {
...
const mapStateToProps = (state) => ({
  is_staff:
    state?.auth?.user?.user?.is_staff || state?.auth?.user?.user?.is_superuser,
});
